      ...
      <footer>
        <div className="container">
          <div className="row pt-5 pb-5">
            {/* mobile */}
            <div className="col-sm-12 right pb-5 mobileDisplay">
              <input
                type="text"
                name="email"
            ...
            <div className="col-md-3 col-sm-12 desktopView">
              <svg
              ...
              <div className="socialIcons down">
                <a href="#">
                  <img
                    width="100%"
                    height="100%"
                ...
                <a href="#">
                  <img width="100%" height="100%" src={youtube} alt="youtube" />
                </a>
                <a href="#">
            ...
            <div className="col-md-3 col-6 commonItems">
              <a href="#">Home</a>
              <a href="#">Pricing</a>
              <a href="#">Products</a>
              <a href="#">About us</a>
            ...
            {/* mobile */}
            <div className="col-sm-12 mobileDisplay">
              <div className="socialIcons down">
                <a href="#">
                  <img
                    width="100%"
            ...
            <div className="col-md-3 col-sm-12 right desktopView">
              <input
                type="text"
                name="email"
                placeholder="Updates in your inbox..."
              ...
              <p className="down">Copyright 2022. All right reserved</p>
            </div>

            <div className="col-sm-12 right mobileDisplay">
              <p className="down">Copyright 2022. All right reserved</p>
            </div>
          </div>

          <div className="attribution pb-5">
            Challenge by
            <a
